create table board1(
	...
	regdate timestamp(6) default sysdate not null enable, --작성날짜
	content varchar2(4000) not null enable, -- 내용
	ip varchar2(20) not null enable, -- 아이피
	constraint board1_pk primary key(num) enable 
);

-- 원글은 0,  답글은 1씩 증가
create sequence board1_seq start with 1 increment by 1 nomaxvalue nocache nocycle;